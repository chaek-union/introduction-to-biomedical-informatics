...
**Figure 6.7** 전위 리드 정렬 예시 - IGV에서 관찰되는 전위 관련 시퀀싱 리드 정렬 패턴
...
### 마이크로위성체 불안정성(Microsatellite Instability, MSI)
...
### 종양 변이 부담(Tumor Mutational Burden, TMB)
...
### 순환종양DNA(Circulating Tumor DNA, ctDNA)
...
**Figure 6.27** 정밀 의학 - 변이 필터링을 통한 임상적으로 유의한 변이 발굴 워크플로우
...
**Figure 6.37** 세포 노화 - 세포 노화를 유발하는 다양한 분자적 메커니즘과 후성유전학적 변화
